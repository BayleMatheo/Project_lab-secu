...
def db_name():
    ...
    for x in db:
        ...
        print("| " + x + " " + db[x] + "|")
        print("|---------|")
    a = input("Choisissez le numéro correspondant au nom de la base de donnée sur laquelle vous voulez continué")
    if a == 0:
        """continué en prenant la base de données choisie pour la suite"""
    return(texte)
